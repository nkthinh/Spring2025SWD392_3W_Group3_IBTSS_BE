...
{
    /// <inheritdoc />
    public partial class CreateFixedDB : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinTicketsRequired = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LocationRouteId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    LocationId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    RouteId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    StopOrder = table.Column<int>(type: "int", nullable: false),
                    StopDuration = table.Column<TimeSpan>(type: "time", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LocationRoutes", x => x.LocationRouteId);
                    table.ForeignKey(
                        name: "FK_LocationRoutes_Locations_LocationId",
                        column: x => x.LocationId,
                        principalTable: "Locations",
                        principalColumn: "LocationId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LocationRoutes_Routes_RouteId",
                        column: x => x.RouteId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LocationRoutes_LocationId",
                table: "LocationRoutes",
                column: "LocationId");

            migrationBuilder.CreateIndex(
                name: "IX_LocationRoutes_RouteId",
                table: "LocationRoutes",
                column: "RouteId");
